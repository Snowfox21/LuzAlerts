...
export default function SettingsScreen() {
    ...
    const [barrioEnabled, setBarrioEnabled] = useState(true);
    ...
    const SETTINGS_DATA: { title: string; data: SettingItem[] }[] = [
        ...
        },
        {
            ...
            data: [
                { id: 'push', label: 'Alertas en tiempo real', type: 'switch', value: pushEnabled, onChange: (v: boolean) => setPushEnabled(v) },
                { id: 'barrio', label: 'Notificar por mi barrio', type: 'switch', value: barrioEnabled, onChange: (v: boolean) => setBarrioEnabled(v) },
            ]
        },
        {
            title: 'Aplicación',
                ...
                renderItem={({ item }) => (
                    ...
                    >
                        ...
                        <View style={styles.rightContent}>
                            {item.value !== null && item.type !== 'switch' && (
